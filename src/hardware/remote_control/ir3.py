...
ir_code_map = {
    ...
    (0xF710EF >> 4) & 0xFFF: "IR_B1",
    (0xF7906F >> 4) & 0xFFF: "IR_B2",
    (0xF750AF >> 4) & 0xFFF: "IR_B3",
    (0xF7D02F >> 4) & 0xFFF: "IR_FLASH",
    (0xF730CF >> 4) & 0xFFF: "IR_B4",
    (0xF7B04F >> 4) & 0xFFF: "IR_B5",
    (0xF7708F >> 4) & 0xFFF: "IR_B6",
    (0xF7F00F >> 4) & 0xFFF: "IR_STROBE",
    (0xF708F7 >> 4) & 0xFFF: "IR_B7",
    (0xF78877 >> 4) & 0xFFF: "IR_B8",
    (0xF748B7 >> 4) & 0xFFF: "IR_B9",
    (0xF7C837 >> 4) & 0xFFF: "IR_FADE",
    (0xF728D7 >> 4) & 0xFFF: "IR_B10",
    (0xF7A857 >> 4) & 0xFFF: "IR_B11",
    (0xF76897 >> 4) & 0xFFF: "IR_B12",
    (0xF7E817 >> 4) & 0xFFF: "IR_SMOOTH"
}

ir_pin=32 # Physical RPI pin
def setup():
        ...
        while True:
            ...
            if code:
                ...
                if trimmed_code in ir_code_map:
                    print(ir_code_map[trimmed_code])
